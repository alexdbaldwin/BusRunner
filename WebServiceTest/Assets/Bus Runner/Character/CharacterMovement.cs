...
public class CharacterMovement : MonoBehaviour
{
    ...
    private float jumpTimerMax = 0.3f;
    private float jumpBoost = 40.0f;
    ...
    public void Move(float move, bool crouch, bool jump)
    {
        ...
        if (m_Grounded || m_AirControl)
        {
            ...
            if(movingPlatform != null)
                m_Rigidbody2D.velocity = new Vector2(m_MaxSpeed + movingPlatform.GetComponent<BusMovementScript>().speed, m_Rigidbody2D.velocity.y);
            else
